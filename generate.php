                ...
                <ul class="navbar-nav mx-auto">
                   ...
                   <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu ">
                         ...
                         <li><a class="dropdown-item" href="#">IMT Atlantique</a></li>
...
function generate_footer($n){
    echo '<footer class="mt-auto" id ="footer">
    <div class="d-flex justify-content-end" style="text-align: center; margin: 1em;", id="reseausocial">
        <li class="list-inline-item" style="width: 32px;height: 32px">
            <a href="https://www.instagram.com/cartel_2024/?igshid=MzRlODBiNWFlZA==">
    ...
    <div class="copyright" style = "text-align: center">
        <p> Copyright 2024 IMT Atlantique - Tous droits réservés</p>
    </div>
